                            ...
                            <div class="col-lg-8 col-sm-10">
                                <div class="text-center mt-lg-5 pt-5">
                                    <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website
                                        with <span class="text-primary">Velzon </span></h1>
                                    ...
                                    <div class="d-flex gap-2 justify-content-center mt-4">
                                        ...
                                        <a href="pages-pricing" class="btn btn-soft-primary">View Plans <i
                    ...
                    <div class="container">
                        <div class="row align-items-center gy-4">
                            <div class="col-lg-6 col-sm-7 mx-auto">
                                <div>
                                    <img src="{{ URL::asset('assets/images/landing/features/img-1.png') }}"
                    ...
                    <div class="container">
                        <div class="row align-items-center gy-4">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <div class="text-muted">
                                    ...
                                    <p class="mb-4 ff-secondary">Quality Dashboards (QD) is a condition-specific,
                                        actionable web-based application for quality reporting and population management
                                        that is integrated into the Electronic Health Record (EHR).</p>
                            ...
                            <div class="col-lg-6 col-sm-7 col-10 ms-auto order-1 order-lg-2">
                                <div>
                                    <img src="{{ URL::asset('assets/images/landing/features/img-2.png') }}"
                                        alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mt-5 pt-lg-5 gy-4">
                            <div class="col-lg-6 col-sm-7 col-10 mx-auto">
                                <div>
                                    <img src="{{ URL::asset('assets/images/landing/features/img-3.png') }}"
                                        alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="genques-collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body ff-secondary">
                                                ...
                                                you didn't know it: the default Office theme, which consists.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="genques-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body ff-secondary">
                                                ...
                                                find it useful to follow the example of a single book.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                                    ...
                                                    <div class="col-10">
                                                        <div class="text-white-50">
                                                            <p class="fs-20 ff-secondary mb-4">" I am givng 5 stars. Theme
                                                                ...
                                                                request should not affect current state of theme. "</p>
                                                    ...
                                                    <div class="col-10">
                                                        <div class="text-white-50">
                                                            <p class="fs-20 ff-secondary mb-4">" Awesome support. Had few
                                                                ...
                                                                team helped me fix them up in a day. Everything looks clean
                                                                and good. Highly recommended! "</p>
                                                    ...
                                                    <div class="col-10">
                                                        <div class="text-white-50">
                                                            <p class="fs-20 ff-secondary mb-4">" Amazing template, Redux
                                                                store and components is nicely designed. It's a great start
                                                                point for an admin based project. Clean Code and good
                                                                documentation. Template is completely in React and
                                                                absolutely no usage of jQuery "</p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="text-center mb-5">
                                    ...
                                    <p class="text-muted mb-4 ff-secondary">In an ideal world this website wouldnâ€™t
                                        exist, a client would acknowledge the importance of having web copy before the Proin
                                        vitae ipsum vel ex finibus semper design starts.</p>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                            ...
                            <div class="col-lg-8">
                                <div class="text-center mb-5">
                                    ...
                                    <p class="text-muted mb-4 ff-secondary">We thrive when coming up with innovative ideas
                                        but also understand that a smart concept should be supported with faucibus sapien
                                        odio measurable results.</p>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <div>
                                    ...
                                    <div class="mt-4 fs-14">
                                        ...
                                        <p class="ff-secondary">You can build any type of web application like eCommerce,
                                            CRM, CMS, Project management apps, Admin Panels, etc using Velzon.</p>
                                    </div>
                                </div>
                            </div>
