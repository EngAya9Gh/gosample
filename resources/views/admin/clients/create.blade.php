...
@section('content')
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.create') }} {{ trans('translation.client') }}</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('arabic_name') ? 'is-invalid' : '' }}" type="text"
                            name="arabic_name" id="arabic_name" value="{{ old('arabic_name', '') }}" placeholder="الاسم العربي">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('english_name') ? 'is-invalid' : '' }}" type="text"
                            name="english_name" id="english_name" value="{{ old('english_name', '') }}" placeholder="English name">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                            name="address" id="address" value="{{ old('address', '') }}" placeholder="Street, city...">
                    ...
                    <div class="col-lg-6 mb-3" data-multi="locations">
                        ...
                        <select class="form-control select2 {{ $errors->has('locations') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($locations as $id => $location)
                                <option value="{{ $id }}" {{ in_array($id, old('locations', [])) ? 'selected' : '' }}>
                                    {{ $location }}
                                </option>
                            @endforeach
                        </select>
