...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h5 class="card-title mb-0">{{ trans('translation.client') }} {{ trans('translation.list') }}</h5>
            @can('client_create')
                <a class="btn btn-create mb-1" href="{{ route('admin.clients.create') }}">
                    <i class="ri-add-line"></i> {{ trans('translation.add') }} {{ trans('translation.client') }}
                </a>
            @endcan
        </div>
