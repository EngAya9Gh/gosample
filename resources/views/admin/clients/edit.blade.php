...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('translation.edit') }} {{ trans('translation.client') }}
        </div>
            ...
            <form method="POST" action="{{ route('admin.clients.update', [$client->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('english_name') ? 'is-invalid' : '' }}"
                                type="text" name="english_name" id="english_name"
                                value="{{ old('english_name', $client->english_name) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="logo">{{ trans('translation.client.fields.logo') }}</label> </br>
