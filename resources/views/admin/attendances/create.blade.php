...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('translation.create') }} {{ trans('translation.attendance') }}
        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime {{ $errors->has('checkin_time') ? 'is-invalid' : '' }}"
                                type="text" name="checkin_time" id="checkin_time" value="{{ old('checkin_time') }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime {{ $errors->has('checkout_time') ? 'is-invalid' : '' }}"
                                type="text" name="checkout_time" id="checkout_time" value="{{ old('checkout_time') }}"
                                required>
