...
@section('content')
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.create') }} {{ trans('cruds.barcode.title_singular') }}</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text"
                            ...
                            placeholder="e.g. SAMPLE, BAG, BOX">
                        @if ($errors->has('type'))
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('last_number') ? 'is-invalid' : '' }}" type="number"
                            name="last_number" id="last_number" value="{{ old('last_number', '') }}" step="1"
                            placeholder="Starting / last issued number">
