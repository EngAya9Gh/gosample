...
<div class="card">
    <div class="card-header">
        {{ trans('translation.create') }} {{ trans('cruds.userAlert.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.user-alerts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div style="padding-bottom: 4px">
                    <span class="btn btn-info btn-xs select-all" style="border-radius: 0">{{ trans('translation.select_all') }}</span>
                    <span class="btn btn-info btn-xs deselect-all" style="border-radius: 0">{{ trans('translation.deselect_all') }}</span>
                </div>
