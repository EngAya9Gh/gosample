...
@section('content')
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.edit') }} {{ trans('cruds.contact.title_singular') }}</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text"
                            name="type" id="type" value="{{ old('type', $contact->type) }}" placeholder="Contact type">
                        @if ($errors->has('type'))
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text"
                            name="email" id="email" value="{{ old('email', $contact->email) }}" placeholder="name@example.com">
                        @if ($errors->has('email'))
