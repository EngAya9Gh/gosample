...
<div class="card">
    <div class="card-header">
        {{ trans('translation.create') }} {{ trans('cruds.carDriver.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.car-drivers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_linked') ? 'is-invalid' : '' }}" type="number" name="is_linked" id="is_linked" value="{{ old('is_linked', '') }}" step="1" required>
