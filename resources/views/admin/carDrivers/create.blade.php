...
@section('content')
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.create') }} {{ trans('cruds.carDriver.title_singular') }}</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('is_linked') ? 'is-invalid' : '' }}" type="number"
                            name="is_linked" id="is_linked" value="{{ old('is_linked', '') }}" step="1" required>
