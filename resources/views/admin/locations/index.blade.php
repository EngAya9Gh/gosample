...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h5 class="card-title mb-0">{{ trans('cruds.location.title_singular') }} {{ trans('global.list') }}</h5>
            @can('location_create')
                <a class="btn btn-create mb-1" href="{{ route('admin.locations.create') }}">
                    <i class="ri-add-line"></i> {{ trans('global.add') }} {{ trans('cruds.location.title_singular') }}
                </a>
            @endcan
        </div>
