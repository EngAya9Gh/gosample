...
@section('content')
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('global.edit') }} {{ trans('cruds.scheduledTask.title_singular') }}</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text"
                            data-mf-date="date" name="start_date" id="start_date"
                            value="{{ old('start_date') ?? $scheduledTask->start_date }}" autocomplete="off" required>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text"
                            data-mf-date="date" name="end_date" id="end_date"
                            value="{{ old('end_date', $scheduledTask->end_date) }}" autocomplete="off" required>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        @if ($errors->has('added_by'))
                            <div class="invalid-feedback">{{ $errors->first('added_by') }}</div>
                        @endif
                        <small class="help-block text-muted">{{ trans('cruds.scheduledTask.fields.added_by_helper') }}</small>
                    </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="selected_hour">{{ trans('cruds.scheduledTask.fields.selected_hour') }}</label>
                        <input type="time" class="form-control {{ $errors->has('selected_hour') ? 'is-invalid' : '' }}"
                            id="selected_hour" name="selected_hour"
                            value="{{ old('selected_hour', $scheduledTask->selected_hour) }}">
                        @if ($errors->has('selected_hour'))
                            <div class="invalid-feedback">{{ $errors->first('selected_hour') }}</div>
                        @endif
                        <small class="help-block text-muted">{{ trans('cruds.scheduledTask.fields.selected_hour_helper') }}</small>
                    </div>
                </div>
