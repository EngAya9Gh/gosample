...
<div class="card">
    <div class="card-header">
        {{ trans('translation.edit') }} {{ trans('translation.term.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.terms.update", [$term->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('english_text') ? 'is-invalid' : '' }}" name="english_text" id="english_text">{{ old('english_text', $term->english_text) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('arabic_text') ? 'is-invalid' : '' }}" name="arabic_text" id="arabic_text">{{ old('arabic_text', $term->arabic_text) }}</textarea>
