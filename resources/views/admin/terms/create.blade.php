...
@section('content')
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.create') }} {{ trans('translation.term.title_singular') }}</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea class="form-control {{ $errors->has('english_text') ? 'is-invalid' : '' }}"
                            name="english_text" id="english_text" rows="5" placeholder="English term text">{{ old('english_text') }}</textarea>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea class="form-control {{ $errors->has('arabic_text') ? 'is-invalid' : '' }}"
                            name="arabic_text" id="arabic_text" rows="5" placeholder="النص باللغة العربية" dir="rtl">{{ old('arabic_text') }}</textarea>
