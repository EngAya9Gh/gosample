...
@section('content')
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.edit') }} {{ trans('translation.container.title_singular') }}</h4>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.containers.update', [$container->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="imei">{{ trans('translation.container.fields.sensor') }}</label>
                        <input class="form-control {{ $errors->has('imei') ? 'is-invalid' : '' }}" type="text"
                            name="imei" id="imei" value="{{ old('imei', $container->imei) }}"
                            placeholder="Enter sensor IMEI" required>
                        @if ($errors->has('imei'))
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="type">{{ trans('translation.container.fields.type') }}</label>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                            ...
                            placeholder="Optional notes about this container">{{ old('description', $container->description) }}</textarea>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="statuss">{{ trans('translation.container.fields.status') }}</label>
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="model">{{ trans('translation.container.fields.model') }}</label>
                        <input class="form-control {{ $errors->has('model') ? 'is-invalid' : '' }}" type="text"
                            name="model" id="model" value="{{ old('model', $container->model) }}"
                            placeholder="Container model" required>
                        @if ($errors->has('model'))
                ...
                <div class="col-lg-12 d-flex justify-content-end flex-wrap mt-2" style="gap: 10px;">
                    <a href="{{ route('admin.containers.index') }}" class="btn btn-reset mb-1">
                        {{ trans('global.cancel') }}
                    </a>
