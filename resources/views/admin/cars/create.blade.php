...
@section('content')
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('translation.create') }} {{ trans('translation.car') }}</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('imei') ? 'is-invalid' : '' }}" type="text"
                            name="imei" id="imei" value="{{ old('imei', '') }}" placeholder="GPS device IMEI" required>
                        @if ($errors->has('imei'))
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('model') ? 'is-invalid' : '' }}" type="text"
                            name="model" id="model" value="{{ old('model', '') }}" placeholder="Car model">
                        @if ($errors->has('model'))
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('color') ? 'is-invalid' : '' }}" type="text"
                            name="color" id="color" value="{{ old('color', '') }}" placeholder="Car color">
                        @if ($errors->has('color'))
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('contact_person') ? 'is-invalid' : '' }}" type="text"
                            name="contact_person" id="contact_person" value="{{ old('contact_person', '') }}"
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                            id="statusInput">
                            <option value="1" {{ (string) old('status', '1') === '1' ? 'selected' : '' }}>Enable</option>
                            <option value="2" {{ (string) old('status', '1') === '2' ? 'selected' : '' }}>Disable</option>
                        </select>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <select class="form-control {{ $errors->has('afaqi') ? 'is-invalid' : '' }}" name="afaqi"
                            id="afaqi" required>
                            <option value="0" {{ (string) old('afaqi', '0') === '0' ? 'selected' : '' }}>No</option>
                            <option value="1" {{ (string) old('afaqi', '0') === '1' ? 'selected' : '' }}>Yes</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                            name="description" id="description" rows="3" placeholder="Optional notes about this car">{{ old('description') }}</textarea>
