...
@section('content')
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('global.edit') }} {{ trans('cruds.moneyTransfer.title_singular') }}</h4>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.money-transfers.update', [$moneyTransfer->id]) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        <label class="required" for="statuss">{{ trans('cruds.moneyTransfer.fields.status') }}</label>
                        ...
                        @endif
                        <small class="help-block text-muted">{{ trans('cruds.moneyTransfer.fields.status_helper') }}</small>
                    </div>
