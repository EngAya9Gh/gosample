    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">
                <i class="ri-user-settings-line"></i> {{ trans('translation.edit') }} {{ trans('translation.driver') }}
            </h4>
        </div>
            ...
            <form method="POST" action="{{ route('admin.drivers.update', [$driver->id]) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                            name="name" id="name" value="{{ old('name', $driver->name) }}"
                    ...
                    <div class="col-lg-6 mb-3">
                        <label for="password">{{ trans('translation.driver.fields.password') }}</label>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text"
                            name="username" id="username" value="{{ old('username', $driver->username) }}"
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text"
                            name="mobile" id="mobile" value="{{ old('mobile', $driver->mobile) }}"
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                            ...
                            @foreach (App\Models\Driver::STATUS_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('status', $driver->status) == (string) $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <div class="input-suffix-wrap">
                                <input class="form-control" type="number" name="total_working_hours"
                                    id="total_working_hours" value="{{ old('total_working_hours', $driver->total_working_hours ?? 8) }}" required>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control driver-time" name="working_hours_start"
                                ...
                                value="{{ old('working_hours_start', $driver->working_hours_start ? \Carbon\Carbon::parse($driver->working_hours_start)->format('H:i') : '') }}"
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control driver-time" name="working_hours_end"
                                ...
                                value="{{ old('working_hours_end', $driver->working_hours_end ? \Carbon\Carbon::parse($driver->working_hours_end)->format('H:i') : '') }}"
                                placeholder="Pick time" autocomplete="off" required>
                        </div>

                        <div class="col-lg-6 mb-3 second-shift-fields" style="{{ old('shift_count', $driver->shift_count) >= 2 ? '' : 'display:none' }}">
                            <label>Shift 2 Start Time</label>
                            <input type="text" class="form-control driver-time" name="second_shift_working_hours_start"
                                value="{{ old('second_shift_working_hours_start', $driver->second_shift_working_hours_start ? \Carbon\Carbon::parse($driver->second_shift_working_hours_start)->format('H:i') : '') }}"
                        ...
                        <div class="col-lg-6 mb-3 second-shift-fields" style="{{ old('shift_count', $driver->shift_count) >= 2 ? '' : 'display:none' }}">
                            ...
                            <input type="text" class="form-control driver-time" name="second_shift_working_hours_end"
                                value="{{ old('second_shift_working_hours_end', $driver->second_shift_working_hours_end ? \Carbon\Carbon::parse($driver->second_shift_working_hours_end)->format('H:i') : '') }}"
                                placeholder="Pick time" autocomplete="off">
                        </div>

                        <div class="col-lg-6 mb-3 third-shift-fields" style="{{ old('shift_count', $driver->shift_count) >= 3 ? '' : 'display:none' }}">
                            <label>Shift 3 Start Time</label>
                            <input type="text" class="form-control driver-time" name="third_shift_working_hours_start"
                                value="{{ old('third_shift_working_hours_start', $driver->third_shift_working_hours_start ? \Carbon\Carbon::parse($driver->third_shift_working_hours_start)->format('H:i') : '') }}"
                                placeholder="Pick time" autocomplete="off">
                        </div>
                        <div class="col-lg-6 mb-3 third-shift-fields" style="{{ old('shift_count', $driver->shift_count) >= 3 ? '' : 'display:none' }}">
                            <label>Shift 3 End Time</label>
                            <input type="text" class="form-control driver-time" name="third_shift_working_hours_end"
                                value="{{ old('third_shift_working_hours_end', $driver->third_shift_working_hours_end ? \Carbon\Carbon::parse($driver->third_shift_working_hours_end)->format('H:i') : '') }}"
                                placeholder="Pick time" autocomplete="off">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input class="form-control" type="text" name="national_id" id="national_id"
                            value="{{ old('national_id', $driver->national_id) }}" placeholder="National ID number" required>
                    </div>
                </div>
                ...
                <div class="col-lg-12 d-flex justify-content-end flex-wrap mt-2" style="gap: 10px;">
                    ...
                    <button class="btn btn-save mb-1" type="submit">
                        <i class="ri-save-3-line"></i> Update Driver Data
                    </button>
                </div>
            </form>
        </div>
