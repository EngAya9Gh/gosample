...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-driverTasks">
            <thead>
                    <tr>
                        <th width="10">
                        ...
                        <tr data-entry-id="{{ $task->id }}">
                            ...
                            <td>
                                <div class="d-flex gap-1 justify-content-center">
                                    @can('task_show')
                                        <a class="btn btn-soft-info btn-sm" href="{{ route('admin.tasks.show', $task->id) }}" title="{{ trans('translation.view') }}">
                                            <i class="ri-eye-fill"></i>
                                        </a>
                                    @endcan

                                    @can('task_edit')
                                        <a class="btn btn-soft-primary btn-sm" href="{{ route('admin.tasks.edit', $task->id) }}" title="{{ trans('translation.edit') }}">
...
@endcan
  ...
  let table = $('.datatable-driverTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
