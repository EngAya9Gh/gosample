...
@section('content')
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('global.create') }} {{ trans('cruds.notification.title_singular') }}</h4>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.notifications.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-lg-12 d-flex justify-content-end flex-wrap mt-2" style="gap: 10px;">
                    <a href="{{ route('admin.notifications.index') }}" class="btn btn-reset mb-1">
                        {{ trans('global.cancel') }}
                    </a>
