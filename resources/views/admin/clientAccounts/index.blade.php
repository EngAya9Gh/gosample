                            ...
                            <td>
                                <div class="d-flex gap-1 justify-content-center">
                                    @can('client_account_show')
                                        <a class="btn btn-soft-info btn-sm" href="{{ route('admin.client-accounts.show', $clientAccount->id) }}" title="{{ trans('translation.view') }}">
                                            <i class="ri-eye-fill"></i>
                                        </a>
                                    @endcan

                                    @can('client_account_edit')
                                        <a class="btn btn-soft-primary btn-sm" href="{{ route('admin.client-accounts.edit', $clientAccount->id) }}" title="{{ trans('translation.edit') }}">
