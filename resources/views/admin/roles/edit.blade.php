...
@section('content')
    @php
        ...
        $updateRoute = $isWeb ? route('admin.roles.update', [$role->id]) : route('admin.client-roles.update', [$role->id]);
    ...
    <div class="card modern-filter-card">
        <div class="card-header">
            <h4 class="card-title mb-0">{{ trans('global.edit') }} {{ trans('cruds.role.title_singular') }}</h4>
        </div>
