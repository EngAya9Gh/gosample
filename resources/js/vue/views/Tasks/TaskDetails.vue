          ...
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400 mt-1.5 flex items-center gap-1.5 font-medium ltr:tracking-wide">
                ...
                <Link v-if="task.historical_car?.id" :href="`/admin/cars/${task.historical_car.id}`" class="hover:underline text-slate-600 dark:text-slate-300">
                  {{ task.historical_car.plate_number }}
                </Link>
