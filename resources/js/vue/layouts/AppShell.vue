...
function onNavigate(target) {
  if (!target) return;
  if (target.startsWith('/admin') && !['/admin/tasks', '/admin/samples', '/admin/tasks/unused', '/admin/scheduled-tasks', '/admin/shipments', '/admin/money-transfers', '/admin/drivers', '/admin/cars'].includes(target)) {
