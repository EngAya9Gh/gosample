...
function onNavigate(target) {
  ...
  const SPA_ADMIN_ROUTES = [
    ...
    '/admin/swaprequests', '/admin/clients', '/admin/locations', '/admin/users', '/admin/roles', '/admin/permissions', '/admin/audit-logs', '/admin/notifications', '/admin/barcodes/generate',
  ];
