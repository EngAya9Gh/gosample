...
<template>
  <header class="relative z-40 flex items-center gap-2 h-16 px-4 bg-surface dark:bg-slate-900/80 backdrop-blur border-b border-slate-200/70 dark:border-white/5">
    ...
    <!-- quick create -->
    <div class="relative">
      <button @click="toggle('create')" class="group inline-flex items-center gap-2 h-10 px-3.5 rounded-xl bg-gradient-to-br from-[#0ea5a4] to-[#0d9488] text-white text-sm font-medium shadow-card hover:brightness-105 hover:-translate-y-0.5 transition-all motion-reduce:transform-none">
        <i class="ri-add-line text-base transition-transform duration-300 group-hover:rotate-90 motion-reduce:transition-none"></i><span class="hidden sm:inline">Create</span>
      </button>
