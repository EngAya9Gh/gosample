<script setup>
/** /admin/driver-schedules/{id}/edit — Edit Driver Schedule. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Driver Schedule updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Driver Schedule" :trail="[{ label:'Driver Schedules', href:'#/admin/driver-schedules' }, { label:'Edit' }]" />
