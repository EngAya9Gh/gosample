<script setup>
/** /admin/attendances/{id}/edit — Edit Attendance. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Attendance updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Attendance" :trail="[{ label:'Attendances', href:'#/admin/attendances' }, { label:'Edit' }]" />
