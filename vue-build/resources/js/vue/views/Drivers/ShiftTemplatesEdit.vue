<script setup>
/** /admin/shift-templates/{id}/edit — Edit Shift Template. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Shift Template updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Shift Template" :trail="[{ label:'Shift Templates', href:'#/admin/shift-templates' }, { label:'Edit' }]" />
