<script setup>
/** /admin/barcodes/{id}/edit — Edit Barcode. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Barcode updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Barcode" :trail="[{ label:'Barcodes', href:'#/admin/barcodes' }, { label:'Edit' }]" />
