...
const f=ref({name:'',arabic:'',desc:'',city:'',neighborhood:'',status:'Active',lat:'24.7136',lng:'46.6753',pickup:'',dropoff:'',mobile:''});
function submit(){ push({type:'success',title:'Saved',message:'Location updated'}); }
</script>
<template>
  <div>
    <Breadcrumb title="Edit Location" :trail="[{label:'Locations',href:'#/admin/locations'},{label:'Edit'}]" />
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
      <BaseCard title="Details" icon="ri-map-pin-2-line">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
          ...
          <FormInput v-model="f.mobile" label="Mobile" />
