<script setup>
/** /admin/shipments/{id}/edit — Edit Shipment. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Shipment updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Shipment" :trail="[{ label:'Shipments', href:'#/admin/shipments' }, { label:'Edit' }]" />
