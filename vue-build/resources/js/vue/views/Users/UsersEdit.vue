<script setup>
/** /admin/users/{id}/edit — Edit User. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'User updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit User" :trail="[{ label:'Users', href:'#/admin/users' }, { label:'Edit' }]" />
