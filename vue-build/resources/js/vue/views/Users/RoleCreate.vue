...
function submit(){ push({type:'success',title:'Saved',message:'Role created with '+sel.value.size+' permissions'}); }
</script>
<template>
  <div>
    <Breadcrumb title="New Role" :trail="[{label:'Roles',href:'#/admin/roles'},{label:'Create'}]" />
