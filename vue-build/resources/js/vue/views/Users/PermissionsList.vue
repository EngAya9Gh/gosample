<script setup>
/** /admin/permissions — Permission list. Auto-faithful to handoff columns. Mock data; wire @query for server-side. */
import { ref } from 'vue';
...
const filters = ref({});
const columns = [{"key":"id","label":"ID","sortable":true,"sticky":"start"},{"key":"name","label":"Name","mono":true},{"key":"guard","label":"Guard Name"}];
const rows = ref([{"id":10428,"name":"Sample Run","guard":"Item 1"},{"id":10427,"name":"Morning Route","guard":"Item 2"},{"id":10426,"name":"Lab Pickup","guard":"Item 3"},{"id":10425,"name":"Cold Transfer","guard":"Item 4"},{"id":10424,"name":"Sample Run","guard":"Item 5"},{"id":10423,"name":"Morning Route","guard":"Item 6"},{"id":10422,"name":"Lab Pickup","guard":"Item 7"},{"id":10421,"name":"Cold Transfer","guard":"Item 8"},{"id":10420,"name":"Sample Run","guard":"Item 9"},{"id":10419,"name":"Morning Route","guard":"Item 10"},{"id":10418,"name":"Lab Pickup","guard":"Item 11"},{"id":10417,"name":"Cold Transfer","guard":"Item 12"},{"id":10416,"name":"Sample Run","guard":"Item 13"},{"id":10415,"name":"Morning Route","guard":"Item 14"},{"id":10414,"name":"Lab Pickup","guard":"Item 15"},{"id":10413,"name":"Cold Transfer","guard":"Item 16"},{"id":10412,"name":"Sample Run","guard":"Item 17"},{"id":10411,"name":"Morning Route","guard":"Item 18"},{"id":10410,"name":"Lab Pickup","guard":"Item 19"},{"id":10409,"name":"Cold Transfer","guard":"Item 20"},{"id":10408,"name":"Sample Run","guard":"Item 21"},{"id":10407,"name":"Morning Route","guard":"Item 22"}]);
...
<template>
  <div>
    <Breadcrumb title="Permissions" :trail="[{ label: 'Permissions' }]">
      <template #actions>
        <BaseButton v-if="can('permission_create')" variant="primary" icon="ri-add-line">Add Permission</BaseButton>
      </template>
    </Breadcrumb>
