<script setup>
/** /admin/permissions/create — New Permission. Mock submit. */
import { ref } from 'vue';
...
const form = ref({"name":""});
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Permission created'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="New Permission" :trail="[{ label:'Permissions', href:'#/admin/permissions' }, { label:'Create' }]" />
