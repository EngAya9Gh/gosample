<script setup>
/** /admin/money-transfers/{id}/edit — Edit Money Transfer. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Money Transfer updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Money Transfer" :trail="[{ label:'Money Transfers', href:'#/admin/money-transfers' }, { label:'Edit' }]" />
