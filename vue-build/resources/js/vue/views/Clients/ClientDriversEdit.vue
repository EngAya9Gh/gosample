<script setup>
/** /admin/client-drivers/{id}/edit — Edit Client Driver. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Client Driver updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Client Driver" :trail="[{ label:'Client Drivers', href:'#/admin/client-drivers' }, { label:'Edit' }]" />
