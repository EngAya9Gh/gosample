<script setup>
/** /admin/contacts/{id}/edit — Edit Contact. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Contact updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Contact" :trail="[{ label:'Contacts', href:'#/admin/contacts' }, { label:'Edit' }]" />
