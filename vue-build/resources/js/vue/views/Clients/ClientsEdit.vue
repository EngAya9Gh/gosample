<script setup>
/** /admin/clients/{id}/edit — Edit Client. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Client updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Client" :trail="[{ label:'Clients', href:'#/admin/clients' }, { label:'Edit' }]" />
