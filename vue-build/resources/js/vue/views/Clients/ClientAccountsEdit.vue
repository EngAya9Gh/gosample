<script setup>
/** /admin/client-accounts/{id}/edit — Edit Client Account. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Client Account updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Client Account" :trail="[{ label:'Client Accounts', href:'#/admin/client-accounts' }, { label:'Edit' }]" />
