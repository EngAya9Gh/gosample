<script setup>
/** /admin/client-locations/create — New Client Location. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Client Location created'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="New Client Location" :trail="[{ label:'Client Locations', href:'#/admin/client-locations' }, { label:'Create' }]" />
