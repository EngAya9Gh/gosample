<script setup>
/** /admin/containers/create — New Container. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Container created'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="New Container" :trail="[{ label:'Containers', href:'#/admin/containers' }, { label:'Create' }]" />
