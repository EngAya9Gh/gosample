<script setup>
/** /admin/swaprequests/{id}/edit — Edit Swap Request. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Swap Request updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Swap Request" :trail="[{ label:'Swap Requests', href:'#/admin/swaprequests' }, { label:'Edit' }]" />
