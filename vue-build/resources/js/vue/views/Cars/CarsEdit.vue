<script setup>
/** /admin/cars/{id}/edit — Edit Car. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Car updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Car" :trail="[{ label:'Cars', href:'#/admin/cars' }, { label:'Edit' }]" />
