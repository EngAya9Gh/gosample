<script setup>
/** /admin/car-drivers/{id}/edit — Edit Car Driver. Mock submit. */
import { ref } from 'vue';
...
function submit(){ saving.value=true; setTimeout(()=>{saving.value=false; push({type:'success',title:'Saved',message:'Car Driver updated'});},700); }
</script>

<template>
  <div>
    <Breadcrumb title="Edit Car Driver" :trail="[{ label:'Car Drivers', href:'#/admin/car-drivers' }, { label:'Edit' }]" />
