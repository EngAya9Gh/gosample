...
export const NAV = [
  {
    label: 'Dashboards', icon: 'ri-dashboard-3-line', items: [
      { label: 'Analytics',         icon: 'ri-line-chart-line',     route: '/dashboard',        perm: 'dashboard_access' },
      { label: 'Delayed Dashboard', icon: 'ri-alarm-warning-line',  route: '/delayeddashboard', perm: 'dashboard_access', badge: 'delayed' },
      { label: 'Car Dashboard',     icon: 'ri-temp-cold-line',      route: '/car-dashboard',    perm: 'dashboard_access' },
      { label: 'Map',               icon: 'ri-map-pin-line',        route: '/map',              perm: 'map_access' },
      { label: 'Tasks Dashboard',   icon: 'ri-bar-chart-grouped-line', route: '/tasks-dashboard', perm: 'dashboard_access' },
      { label: 'Daily Operation',   icon: 'ri-file-list-3-line',    route: '/daily-operation',  perm: 'dashboard_access' },
    ],
  },
  {
  ...
  },
  {
    label: 'Tasks', icon: 'ri-task-line', items: [
      ...
      { label: 'Driver Tracking',  icon: 'ri-route-line',          route: '/admin/driver-tracking',  perm: 'task_access' },
      { label: 'Scheduled Tasks',  icon: 'ri-calendar-schedule-line', route: '/admin/scheduled-tasks', perm: 'task_access' },
      { label: 'System Calendar',  icon: 'ri-calendar-2-line',     route: '/admin/system-calendar',  perm: 'task_access' },
      { label: 'Create Task',      icon: 'ri-add-circle-line',     route: '/admin/tasks/create',     perm: 'task_create' },
      { label: 'Missing Tasks',    icon: 'ri-question-mark',       route: '/admin/tasks/missing',    perm: 'task_access' },
      { label: 'Lost Samples',     icon: 'ri-flask-line',          route: '/admin/lost',             perm: 'sample_access', badge: 'lost' },
      { label: 'Scan',             icon: 'ri-qr-scan-2-line',      route: '/admin/tasks/scan',       perm: 'task_access' },
      { label: 'Unused Tasks',     icon: 'ri-inbox-unarchive-line', route: '/admin/tasks/unused',    perm: 'task_access' },
      ...
      { label: 'Money Transfers',  icon: 'ri-money-dollar-circle-line', route: '/admin/money-transfers', perm: 'money_access' },
    ],
  },
  {
    label: 'Drivers', icon: 'ri-steering-2-line', items: [
      ...
      { label: 'Car Link Histories', icon: 'ri-links-line',        route: '/admin/car-link-histories', perm: 'car_access' },
      ...
      { label: 'Shift Templates',    icon: 'ri-calendar-check-line', route: '/admin/shift-templates',  perm: 'shift_access' },
      { label: 'Swap Requests',      icon: 'ri-swap-line',         route: '/admin/swaprequests',       perm: 'task_access', badge: 'swap' },
    ],
  },
  {
  ...
  },
  {
    label: 'Settings', icon: 'ri-settings-3-line', items: [
      { label: 'Audit Logs',        icon: 'ri-history-line',       route: '/admin/audit-logs',        perm: 'audit_access' },
      ...
      { label: 'Generate Barcodes', icon: 'ri-barcode-box-line',   route: '/admin/barcodes/generate', perm: 'barcode_create' },
      { label: 'Notifications',     icon: 'ri-notification-3-line', route: '/admin/notifications',    perm: 'notification_access' },
      { label: 'API Ayenati',       icon: 'ri-cloud-line',         route: '/admin/api-ayenatis',      perm: 'api_access' },
      { label: 'Delete Permissions', icon: 'ri-delete-bin-7-line', route: '/admin/delete-permissions', perm: 'superadmin' },
    ],
  },
];
