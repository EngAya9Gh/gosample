...
class TaskSwapTimeReportExport implements FromQuery, WithHeadings, WithMapping,ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    public function map($task): array
    {
        ...
        return [
            ...
            $closeDate,
            $closeTime,
            $task->old_driver_name ?? 'N/A',
            $task->driver_name ?? 'N/A',
            $task->freezer_date ?? 'N/A',
            $task->swap_freezer_in ?? 'N/A',
            $task->freezer_out_date ?? 'N/A',
            $task->swap_freezer_out ?? 'N/A',
